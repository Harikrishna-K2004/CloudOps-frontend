...
function DropdownMenuTrigger({
  ...
  /*
   * Base UI's Menu.Trigger renders a <button> by default.
   *
   ...
   * </DropdownMenuTrigger>
   *
   * Since Button also renders a <button>, that previously produced:
   *
   * <button>
   *   <button>...</button>
   * </button>
   *
   * Using `render` tells Base UI to use the supplied Button as the
   * actual trigger element instead of creating another button.
   */
...
function DropdownMenuLabel({
  ...
  /*
   * MenuPrimitive.GroupLabel requires a MenuPrimitive.Group context.
   *
   * The existing application uses DropdownMenuLabel directly inside
   * DropdownMenuContent, so using GroupLabel caused:
   *
   * "MenuGroupContext is missing"
   *
   * A regular div is sufficient for a dropdown heading and avoids
   * requiring every label to be wrapped in DropdownMenuGroup.
   */
  return (
    <div
